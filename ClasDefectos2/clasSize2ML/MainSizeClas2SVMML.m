...
pathResultados=strcat(pathPrincipal,'output/clasSize2ML/');
...
% la eficacia
 ...
 nombreArchivoSetCompleto='aTSCSize2ML.csv';
 
 
 %Leer las 
 nombreArchivoTraining='aTSSize2SVMML.csv';
 nombreArchivoTest='aTSize2SVMML.csv';
 nombreArchivoScreen='screenSize2SVMML.txt'; 
...
%tablaDSTrainingCaracteristicas=tablaDSTraining(:,EJE_MAYOR_SOFTWARE,EJE_MENOR_SOFTWARE);
%tablaDSTrainingCaracteristicas=tablaDSTraining(:,30,33);

tablaDSTrainingCaracteristicas=tablaDSTraining(:,{'ejeMayormmR1','ejeMenormmR1'});
%tablaDSTraining(:,{'nombre_imagen','ejeMayormmR1','ejeMenormmR1'})
...
% mismas
fprintf('Entrenando clasificador SVM multiclase\n');
...
% recortes
%tablaDSTestComparar=tablaDSTest(:,EJE_MAYOR_SOFTWARE,EJE_MENOR_SOFTWARE);
tablaDSTestComparar=tablaDSTest(:,{'ejeMayormmR1','ejeMenormmR1'});
%tablaDSTest(:,{'nombre_imagen','ejeMayormmR1','ejeMenormmR1'})
...
for indiceTest=1:totalArrayTest
    ...
    etiquetaComparar=char(table2array(tablaDSTest(indiceTest,ETIQUETA_EXPERTO)));
    %
    ...
    if(strcmp(etiquetaComparar,clasificacionObjeto(1)))
        ...
        fprintf('%s, ejeMayorSoft_mmR1 = %f, ejeMenorSoft_mmR1 = %f',nombreDelaImagenComparar, double(objetoComparar(1,1)), double(objetoComparar(1,2)));        
