...
% la eficacia
 ...
 nombreArchivoSetCompleto='aTSCompletoSizeML.csv';
 
 
 %Leer las 
 nombreArchivoTraining='aTrainingSizeML.csv';
 nombreArchivoTest='aTestSizeML.csv';
...
% menor en milímetros
tablaDSTrainingCaracteristicas=tablaDSTraining(:,30:31);
