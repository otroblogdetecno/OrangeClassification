...
for n=1:size(listado)
    ...
    %nombreImagenP='191.jpg';
    ProcesamientoImagen(pathEntradaImagenes, pathAplicacion, nombreImagenP, ArrayCuadros, areaObjetosRemoverBR, canalLMin, canalLMax, canalAMin, canalAMax, canalBMin, canalBMax )
    ExtraerDefImagen(pathEntradaImagenes, pathAplicacion, nombreImagenP, archivoVectorDef, tamanoManchas)
    %break;
end %
