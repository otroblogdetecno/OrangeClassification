...
pathResultados=strcat(pathPrincipal,'output/clasSizeUM/');
 ...
 nombreArchivoMC1='resultadomEMc1.csv';
 nombreArchivoMC2='resultadomEMc2.csv';
 nombreArchivoMC3='resultadomEMc3.csv';
 
 %Leer las 
 nombreArchivoTest='aTSCSize2UM.csv';
nombreArchivoScreen='screenSize2EM.txt'; 
...
tablaDSTestComparar=tablaDSTest(:,EJE_MENOR_SOFTWARE);
