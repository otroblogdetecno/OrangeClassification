...
% la eficacia
 ...
 nombreArchivoSetCompleto='aTSCSize24RML.csv';
 
 
 %Leer las 
 nombreArchivoTraining='aTSSize24RML.csv';
 nombreArchivoTest='aTSize24RML.csv';
 nombreArchivoScreen='screenSize24RML.txt'; 
