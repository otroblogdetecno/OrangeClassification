...
% la eficacia
 ...
 nombreArchivoSetCompleto='aTSCSize2SVM4RML.csv';
 
 
 %Leer las 
 nombreArchivoTraining='aTSSize2SVM4RML.csv';
 nombreArchivoTest='aTSize2SVM4RML.csv';
 nombreArchivoScreen='screenSize2SVM4RML.txt'; 
