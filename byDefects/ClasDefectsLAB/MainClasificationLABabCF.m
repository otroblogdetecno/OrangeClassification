...
%% Conjunto general de entrenamiento 
 nombreArchivoSetCompleto='aTSCLABabCF.csv';
 
 %Leer las 
 nombreArchivoTraining='aTrainingLABabCF.csv';
 nombreArchivoTest='aTestLABabCF.csv';
 nombreArchivoScreen='screenLABabCF.txt';  
% 
