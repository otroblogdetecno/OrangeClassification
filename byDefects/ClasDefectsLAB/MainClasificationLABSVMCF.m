...
%% Conjunto general de entrenamiento 
 nombreArchivoSetCompleto='aTSCLABSVMCF.csv';
 
 %Leer las 
 nombreArchivoTraining='aTrainingLABSVMCF.csv';
 nombreArchivoTest='aTestLABSVMCF.csv';
 nombreArchivoScreen='screenLABSVMCF.txt'; 
