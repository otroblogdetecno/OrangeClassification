function [ ] = ProcesarImagenLAB( corrida, pathPrincipal, pathEntrada, pathConfiguracion, pathAplicacion, pathResultados, banderaCalibracion, banderaRotar, nombreImagenP, archivoConfiguracion, archivoCalibracion, archivoVector )
...
recortarImagenLAB(imagenInicial, banderaRotar, nombreImagenRecorte1, Cuadro1_lineaGuiaInicialColumna, Cuadro1_lineaGuiaInicialFila, Cuadro1_espacioColumna, Cuadro1_espacioFila);

%Recuadro 2 izquierda
recortarImagenLAB(imagenInicial, banderaRotar, nombreImagenRecorte2, Cuadro2_lineaGuiaInicialColumna, Cuadro2_lineaGuiaInicialFila, Cuadro2_espacioFila, Cuadro2_espacioColumna);

%Recuadro 3 centro
recortarImagenLAB(imagenInicial, banderaRotar, nombreImagenRecorte3, Cuadro3_lineaGuiaInicialColumna, Cuadro3_lineaGuiaInicialFila, Cuadro3_espacioColumna, Cuadro3_espacioFila);

%Recuadro 4 derecha
recortarImagenLAB(imagenInicial, banderaRotar, nombreImagenRecorte4, Cuadro4_lineaGuiaInicialColumna, Cuadro4_lineaGuiaInicialFila, Cuadro4_espacioFila, Cuadro4_espacioColumna);

%% Aplicando operaciones morfologicas
fprintf('Aplicando operaciones morfologicas --> \n');
operacionesMorfologicasLAB(nombreImagenRecorte1,nombreImagenSilueta1);
operacionesMorfologicasLAB(nombreImagenRecorte2,nombreImagenSilueta2);
operacionesMorfologicasLAB(nombreImagenRecorte3,nombreImagenSilueta3);
operacionesMorfologicasLAB(nombreImagenRecorte4,nombreImagenSilueta4);

%% Removiendo objetos pequeños
fprintf('Removiendo objetos pequeños --> \n');
removerObjetosLAB(nombreImagenSilueta1, nombreImagenSiluetaN1, areaObjetosRemover);
removerObjetosLAB(nombreImagenSilueta2, nombreImagenSiluetaN2, areaObjetosRemover);
removerObjetosLAB(nombreImagenSilueta3, nombreImagenSiluetaN3, areaObjetosRemover);
removerObjetosLAB(nombreImagenSilueta4, nombreImagenSiluetaN4, areaObjetosRemover);


%% Removiendo fondo
fprintf('Removiendo fondo --> \n');
removerFondoLAB(nombreImagenRecorte1, nombreImagenSiluetaN1, nombreImagenRemovida1);
removerFondoLAB(nombreImagenRecorte2, nombreImagenSiluetaN2, nombreImagenRemovida2);
removerFondoLAB(nombreImagenRecorte3, nombreImagenSiluetaN3, nombreImagenRemovida3);
removerFondoLAB(nombreImagenRecorte4, nombreImagenSiluetaN4, nombreImagenRemovida4);
...
guardarArchivoVectorLAB( archivoVector, fila)
