...
%% Conjunto general de entrenamiento 
 nombreArchivoSetCompleto='aTSCLABabSVMCF.csv';
 
 %Leer las 
 nombreArchivoTraining='aTrainingLABabSVMCF.csv';
 nombreArchivoTest='aTestLABabSVMCF.csv';
 nombreArchivoScreen='screenLABabSVMCF.txt';  
% 
...
%    objetoComparar = arrayTest(indiceTest,1:3); %objeto a comparar
    ...
    if(strcmp(etiquetaComparar,clasificacionObjeto(1)))
        ...
        fprintf('%s, *a = %f, *b = %f, ',nombreDelaImagenComparar, double(objetoComparar(1)), double(objetoComparar(2)));                
