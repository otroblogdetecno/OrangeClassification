...
nombreImagenP='117.jpg';
 ...
 pathPrincipal='/home/usuario/ml/clasDefectsLAB/'; 
...
for n=1:size(listado)
    ...
    ProcesarImagenLAB( corrida, pathPrincipal, pathEntradaAprender, pathConfiguracion, pathAplicacionAprender, pathResultados, banderaCalibracion, banderaRotar, nombreImagenP, archivoConfiguracion, archivoCalibracion, archivoVector );
end %
