function [ ] = objectDetectionCut( imagenNombreFR, imagenNombreROI, nombreImagenRemovida, ArrayCuadros)
% ########################################################################
...
%    fprintf('---INICIO DETECCION DE CUADROS ---\n');
    numeroCuadro=rectangleDetection(ArrayCuadros, coordenadasAPintar(1), coordenadasAPintar(2)); %asigma el numero de cuadro que corresponde a la imagen
