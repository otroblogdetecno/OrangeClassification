function [ sumaArea, redondez, diametro, ejeMayor, ejeMenor, totalPixelesManchas, totalManchas ] = extraerCarSobel( imagenNombreSilueta1, nombreImagenDefectosND1, nombreImagenDefectosND2, nombreImagenDefectosND3, nombreImagenDefectosND4)
...
[sumaParcial1, totalManchas1]=extraerPixelesManchasSobel(nombreImagenDefectosND1);

%% imagen 2
[sumaParcial2, totalManchas2]=extraerPixelesManchasSobel(nombreImagenDefectosND2);

%% imagen 3
[sumaParcial3, totalManchas3]=extraerPixelesManchasSobel(nombreImagenDefectosND3);


%% imagen 4 
[sumaParcial4, totalManchas4]=extraerPixelesManchasSobel(nombreImagenDefectosND4);
