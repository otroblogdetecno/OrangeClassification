...
%% Conjunto general de entrenamiento 
 nombreArchivoSetCompleto='aTSCSobelSVMCF.csv';
 
 %Leer las 
 nombreArchivoTraining='aTrainingSobelVMCF.csv';
 nombreArchivoTest='aTestSobelSVMCF.csv';
nombreArchivoScreen='screenSobelSVMCF.txt'; 
...
fprintf('PRUEBA # %i \n',prueba);
fprintf('-----------------------------------\n');
dividirConjuntosSobel( proporcionTraining, pathPrincipal, pathResultados, nombreArchivoSetCompleto, nombreArchivoTraining, nombreArchivoTest);
