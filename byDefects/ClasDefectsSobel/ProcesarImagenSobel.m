function [ output_args ] = ProcesarImagenSobel( corrida, pathPrincipal, pathEntrada, pathConfiguracion, pathAplicacion, pathResultados, banderaCalibracion, banderaRotar, nombreImagenP, archivoConfiguracion, archivoCalibracion, archivoVector )
...
recortarImagenSobel(imagenInicial, banderaRotar, nombreImagenRecorte1, Cuadro1_lineaGuiaInicialColumna, Cuadro1_lineaGuiaInicialFila, Cuadro1_espacioColumna, Cuadro1_espacioFila);

%Recuadro 2 izquierda
recortarImagenSobel(imagenInicial, banderaRotar, nombreImagenRecorte2, Cuadro2_lineaGuiaInicialColumna, Cuadro2_lineaGuiaInicialFila, Cuadro2_espacioFila, Cuadro2_espacioColumna);

%Recuadro 3 centro
recortarImagenSobel(imagenInicial, banderaRotar, nombreImagenRecorte3, Cuadro3_lineaGuiaInicialColumna, Cuadro3_lineaGuiaInicialFila, Cuadro3_espacioColumna, Cuadro3_espacioFila);

%Recuadro 4 derecha
recortarImagenSobel(imagenInicial, banderaRotar, nombreImagenRecorte4, Cuadro4_lineaGuiaInicialColumna, Cuadro4_lineaGuiaInicialFila, Cuadro4_espacioFila, Cuadro4_espacioColumna);

%% Aplicando operaciones morfologicas
fprintf('Aplicando operaciones morfologicas --> \n');
operacionesMorfologicasSobel(nombreImagenRecorte1,nombreImagenSilueta1);
operacionesMorfologicasSobel(nombreImagenRecorte2,nombreImagenSilueta2);
operacionesMorfologicasSobel(nombreImagenRecorte3,nombreImagenSilueta3);
operacionesMorfologicasSobel(nombreImagenRecorte4,nombreImagenSilueta4);

%% Removiendo objetos pequeños
fprintf('Removiendo objetos pequeños --> \n');
removerObjetosSobel(nombreImagenSilueta1, nombreImagenSiluetaN1, areaObjetosRemover);
removerObjetosSobel(nombreImagenSilueta2, nombreImagenSiluetaN2, areaObjetosRemover);
removerObjetosSobel(nombreImagenSilueta3, nombreImagenSiluetaN3, areaObjetosRemover);
removerObjetosSobel(nombreImagenSilueta4, nombreImagenSiluetaN4, areaObjetosRemover);


%% Removiendo fondo
fprintf('Removiendo fondo --> \n');
removerFondoSobel(nombreImagenRecorte1, nombreImagenSiluetaN1, nombreImagenRemovida1);
removerFondoSobel(nombreImagenRecorte2, nombreImagenSiluetaN2, nombreImagenRemovida2);
removerFondoSobel(nombreImagenRecorte3, nombreImagenSiluetaN3, nombreImagenRemovida3);
removerFondoSobel(nombreImagenRecorte4, nombreImagenSiluetaN4, nombreImagenRemovida4);


%% Tercera opcion, segmentacion con TopHat, Sobel.
fprintf('Sobel Tophat --> \n');
tamanoManchas=1500;   
%Imagen 1 
   SegmentacionSobel(nombreImagenRemovida1, nombreImagenSalida1);
   extraerRegionManchasSobel( nombreImagenSalida1, nombreImagenDefectos1, tamanoManchas);
   
   %Imagen 2
   SegmentacionSobel(nombreImagenRemovida2, nombreImagenSalida2);
   extraerRegionManchasSobel( nombreImagenSalida2, nombreImagenDefectos2, tamanoManchas);
    
    %Imagen 3
   SegmentacionSobel(nombreImagenRemovida3, nombreImagenSalida3);
   extraerRegionManchasSobel( nombreImagenSalida3, nombreImagenDefectos3, tamanoManchas);    
    
   %Imagen 4
   SegmentacionSobel(nombreImagenRemovida4, nombreImagenSalida4);
   extraerRegionManchasSobel( nombreImagenSalida4, nombreImagenDefectos4, tamanoManchas);
...
[ sumaArea, redondez, diametro, ejeMayor, ejeMenor, totalPixelesManchas, totalManchas ] = extraerCarSobel( nombreImagenRemovida1, nombreImagenDefectos1, nombreImagenDefectos2, nombreImagenDefectos3, nombreImagenDefectos4);
...
guardarArchivoVectorSobel( archivoVector, fila)
