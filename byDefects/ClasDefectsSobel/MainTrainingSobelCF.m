...
nombreImagenP='117.jpg';
 ...
 pathPrincipal='/home/usuario/ml/clasDefectsSobel/'; 
 pathConfiguracion=strcat(pathPrincipal,'conf/');
 pathResultados=strcat(pathPrincipal,'output/');
 
  pathEntradaAprender='/home/usuario/ml/inputToLearn/';
 %pathEntradaAprender=strcat(pathPrincipal,'inputToLearn/');
  pathAplicacionAprender=strcat(pathPrincipal,'tmpToLearnSobel/');
...
%% Nombres de archivos 
 ...
 archivoVector=strcat(pathResultados,'aSobelCF.csv');
...
for n=1:size(listado)
    ...
    ProcesarImagenSobel( corrida, pathPrincipal, pathEntradaAprender, pathConfiguracion, pathAplicacionAprender, pathResultados, banderaCalibracion, banderaRotar, nombreImagenP, archivoConfiguracion, archivoCalibracion, archivoVector );
end %
