...
%% Conjunto general de entrenamiento 
 nombreArchivoSetCompleto='aTSCSobelCF.csv';
 
 %Leer las 
 nombreArchivoTraining='aTrainingSobelCF.csv';
 nombreArchivoTest='aTestSobelCF.csv';
nombreArchivoScreen='screenSobelCF.txt'; 
