...
nombreImagenP='117.jpg';
 ...
 pathEntradaAprender='/home/usuario/ml/inputToLearnCalyx/sinCalyxCF/';
 pathAplicacionAprender=strcat(pathPrincipal,'tmpToLearnPrewitt/sinCalyxCF/');
...
%% Nombres de archivos 
 ...
 archivoVector=strcat(pathResultados,'aMSinCalyxCF.csv');
...
for n=1:size(listado)
    fprintf('Extrayendo características para entrenamiento Prewitt-> %s \n',listado(n).name);    
