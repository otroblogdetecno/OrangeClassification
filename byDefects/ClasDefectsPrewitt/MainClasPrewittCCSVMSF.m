...
nombreArchivoSetCompleto='aCSMConCalyxSVMSF.csv'; 
%Leer las 
nombreArchivoTraining='aTSMConCalyxSVMSF.csv';
nombreArchivoTest='aTTMConCalyxSVMSF.csv';
nombreArchivoScreen='SCMConCalyxSVMSF.txt'; 
