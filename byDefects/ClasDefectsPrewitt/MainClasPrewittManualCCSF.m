...
nombreArchivoSetCompleto='aCSMConCalyxManualSF.csv'; 
%Leer las 
nombreArchivoTraining='aTSMConCalyxManualSF.csv';
nombreArchivoTest='aTTMConCalyxManualSF.csv';
nombreArchivoScreen='SCMConCalyxManualSF.txt'; 
