...
pathResultados=strcat(pathPrincipal,'output/sinCalyxCF/');
...
nombreArchivoSetCompleto='aCSMSinCalyxSVMCF.csv';
 
 %Leer las 
nombreArchivoTraining='aTSMSinCalyxSVMCF.csv';
nombreArchivoTest='aTTMSinCalyxSVMCF.csv';
nombreArchivoScreen='SCMSinCalyxSVMCF.txt'; 
...
fprintf('PRUEBA # %i \n',prueba);
fprintf('-----------------------------------\n');
dividirConjuntosPrewitt( proporcionTraining, pathPrincipal, pathResultados, nombreArchivoSetCompleto, nombreArchivoTraining, nombreArchivoTest);
