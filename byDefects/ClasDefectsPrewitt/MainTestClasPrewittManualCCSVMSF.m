...
nombreArchivoSetCompleto='aMConCalyxManualSVMSF.csv';
 
 %Leer las 
nombreArchivoTraining='aTSMConCalyxManualSVMSF.csv';
nombreArchivoTest='aTTMConCalyxManualSVMSF.csv';
nombreArchivoScreen='SCMConCalyxSVMManualSF.txt'; 
