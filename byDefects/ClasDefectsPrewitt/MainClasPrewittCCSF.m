...
%% Conjunto general de entrenamiento 
 nombreArchivoSetCompleto='aMCSConCalyxSF.csv'; 
%Leer las 
nombreArchivoTraining='aTSMConCalyxSF.csv';
nombreArchivoTest='aTTMConCalyxSF.csv';
nombreArchivoScreen='SCMConCalyxSF.txt'; 
