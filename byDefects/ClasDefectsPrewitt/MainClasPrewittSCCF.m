...
%% Conjunto general de entrenamiento 
 nombreArchivoSetCompleto='aCSMSinCalyxCF.csv';
 
 %Leer las 
nombreArchivoTraining='aTSMSinCalyxCF.csv';
nombreArchivoTest='aTTMSinCalyxCF.csv';
nombreArchivoScreen='SCMSinCalyxCF.txt'; 
