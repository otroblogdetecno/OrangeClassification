...
nombreArchivoSetCompleto='aCSMConCalyxCF.csv';
 
 %Leer las 
 nombreArchivoTraining='aTSMConCalyxCF.csv';
 nombreArchivoTest='aTTMConCalyxCF.csv';
 nombreArchivoScreen='SCMConCalyxCF.txt'; 
