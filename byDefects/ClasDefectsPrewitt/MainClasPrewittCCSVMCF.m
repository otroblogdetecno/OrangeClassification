...
pathResultados=strcat(pathPrincipal,'output/conCalyxCF/');
...
nombreArchivoSetCompleto='aCSMConCalyxSVMCF.csv';
 
%Leer las 
nombreArchivoTraining='aTSMConCalyxSVMCF.csv';
nombreArchivoTest='aTTMConCalyxSVMCF.csv';
nombreArchivoScreen='SCMConCalyxSVMCF.txt'; 
