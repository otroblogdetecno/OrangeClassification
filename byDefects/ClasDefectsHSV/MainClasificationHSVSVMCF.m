...
% la eficacia
 ...
 nombreArchivoSetCompleto='aTSCHSVSVMCF.csv';
 
 %Leer las 
nombreArchivoTraining='aTrainingHSVSVMCF.csv';
nombreArchivoTest='aTestHSVSVMCF.csv';
nombreArchivoScreen='screenHSVSVMCF.txt'; 
% 
...
fprintf('PRUEBA # %i \n',prueba);
fprintf('-----------------------------------\n');
dividirConjuntosHSV( proporcionTraining, pathPrincipal, pathResultados, nombreArchivoSetCompleto, nombreArchivoTraining, nombreArchivoTest);
