...
nombreImagenP='117.jpg';
 ...
 pathPrincipal='/home/usuario/ml/clasDefectsHSV/'; 
 pathConfiguracion=strcat(pathPrincipal,'conf/');
 pathResultados=strcat(pathPrincipal,'output/');
 
pathEntradaAprender=strcat('/home/usuario/ml/inputToLearn/');
...
for n=1:size(listado)
    ...
    ProcesarImagenHSV( corrida, pathPrincipal, pathEntradaAprender, pathConfiguracion, pathAplicacionAprender, pathResultados, banderaCalibracion, banderaRotar, nombreImagenP, archivoConfiguracion, archivoCalibracion, archivoVector );
end %
