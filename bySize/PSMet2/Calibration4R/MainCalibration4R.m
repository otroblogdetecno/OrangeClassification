...
clc; clear all; close all;
 ...
 HOMEUSER=strcat(pwd,'/');
 pathPrincipal=strcat(HOMEUSER,'OrangeResults/bySize/PSMet2/Calibration4R/');
 pathEntradaCalibracion=strcat('/home/usuario/OrangeResults/inputToCalibrate/');
 pathEntradaSamples=strcat('/home/usuario/OrangeResults/inputToCalibrate/');
