...
initialImage=strcat(pathInput,mainImageName);


%% Temporary directories
pathApplicationPR=strcat(pathApplication,'pr/'); %pre procesing
pathApplicationBR=strcat(pathApplication,'br/'); %background removal
pathApplicationROI=strcat(pathApplication,'roi/'); %region of interest


pathApplication2=strcat(pathApplication,'sFruits/');
pathApplication3=strcat(pathApplication,'removed/');

% --- NOMBRE DE IMAGENES INTERMEDIAS ---
% con fondo removido
imagenNombrePR=strcat(pathApplicationPR,mainImageName,'_','PR.jpg'); %imagen RGB con lineas pintadas;
ImageNameBR=strcat(pathApplicationBR,mainImageName,'_','BR.jpg'); %para indicar silueta del fondo removido
ImageNameROI=strcat(pathApplicationROI,mainImageName,'_','RO.jpg'); %para indicar el fondo removido y ROI

%prefijo para imagenes de fondo removido y siluetas de fondos removidos en
%deteccion de objetos
imageNameSilhouetteN=strcat(pathApplication2,mainImageName,'_','sN');
imageNameRemoved=strcat(pathApplication3,mainImageName,'_','rm');

% Siluetas operaciones morfologicas
imageNameSilhouetteN1=strcat(pathApplication2,mainImageName,'_','sN1.jpg');
imageNameSilhouetteN2=strcat(pathApplication2,mainImageName,'_','sN2.jpg');
imageNameSilhouetteN3=strcat(pathApplication2,mainImageName,'_','sN3.jpg');
imageNameSilhouetteN4=strcat(pathApplication2,mainImageName,'_','sN4.jpg');

% nombres de archivos con objetos removidos
imageNameRemoved1=strcat(pathApplication3,mainImageName,'_','rm1.jpg');
imageNameRemoved2=strcat(pathApplication3,mainImageName,'_','rm2.jpg');
imageNameRemoved3=strcat(pathApplication3,mainImageName,'_','rm3.jpg');
imageNameRemoved4=strcat(pathApplication3,mainImageName,'_','rm4.jpg');
