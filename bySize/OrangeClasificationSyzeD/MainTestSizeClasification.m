...
clc; clear all; close all;
 ...
 pathResultados=strcat(pathPrincipal,'output/clasSizeD/');
 ...
 %Leer las 
 nombreArchivoTest='aTSCompletoSizeD.csv';
nombreArchivoScreen='screenManchasSCD.txt'; 
...
%        fprintf('%s, Eje mayor = %f, , Eje menor = %f, ce= %s ',nombreDelaImagenComparar, double(objetoComparar(1,1)), double(objetoComparar(1,2)),etiquetaComparar);        
        fprintf('%s, Diametro_mm = %f, ',nombreDelaImagenComparar, double(objetoComparar(1,1)));        
