...
[ sumaArea, redondez, diametro, ejeMayor, ejeMenor] = extraccionCaracteristicas( nombreImagenRemovida1, nombreImagenRemovida2, nombreImagenRemovida3, nombreImagenRemovida4, nombreImagenSiluetaN1, nombreImagenSiluetaN2, nombreImagenSiluetaN3, nombreImagenSiluetaN4);


% Cálculo para unidades de medida
diametromm=diametro*pixelmm;
sumaAreamm=sumaArea*pixelCuadrado;
ejeMayormm=ejeMayor*pixelmm;
ejeMenormm=ejeMenor*pixelmm;



%% Guardado en archivo
clase='SIN_CLASIFICAR';
     fprintf('%s, %10.4f, %10.2i, %10.4f, %10.4f, %10.4f, %10.4f, %10.4f, %10.4f, %10.4f, %10.4f, %s \n',imagenInicial, pixelmm, sumaArea, sumaAreamm, redondez, diametro, diametromm, ejeMayor, ejeMenor, ejeMayormm, ejeMenormm, clase);
